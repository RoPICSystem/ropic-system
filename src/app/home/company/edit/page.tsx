  ...
  useEffect(() => {
    async function fetchCompanyData() {
      try {
        ...
        const reg_code = companyData?.address?.region?.code
        const prov_code = companyData?.address?.province?.code
        const citymun_code = companyData?.address?.municipality?.code
