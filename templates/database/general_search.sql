...
CREATE OR REPLACE FUNCTION public.general_search(
  ...
  p_entity_type TEXT DEFAULT NULL, -- 'inventory', 'warehouse', 'delivery', 'reorder_point', 'warehouse_inventory', 'inventory_item', 'warehouse_inventory_item', 'new_warehouse_inventory'
